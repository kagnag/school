...
def bin2hex(s):
    '''Doi nhi phan sang thap luc phan'''
    mp = {"0000": '0',
          "0001": '1',
          "0010": '2',
          "0011": '3',
...
def DES_encrypt(pt, rkb, rk):
    ...
    # Phan chia thanh nua trai va nua phai
    left = pt[0:32]
    right = pt[32:64]
    for i in range(0, 16):
        # Nua phai qua ham mo rong (32bit -> 48 bit)
        right_expanded = permute(right, exp_d, 48)

        # XOR RoundKey[i] va right_expanded
        ...
        # print(
        #     f"Round {i + 1} {bin2hex(left)} {bin2hex(right)} {rk[i]} {rkb[i]}")
...
# rkb_rev = rkb[::-1]
# rk_rev = rk[::-1]
# text = bin2hex(DES_encrypt(cipher_text, rkb_rev, rk_rev))
