(define (problem hard3)
    ...
    (:init  (tile t1) (tile t2) (tile t3) (tile t4) 
            ...
            (blank x3 y2)
            (at t2 x1 y1) (at t1 x2 y1) (at t7 x3 y1) (at t8 x1 y2) (at t6 x2 y2) 
            (at t3 x1 y3) (at t4 x2 y3) (at t5 x3 y3)
    )
    (:goal  (and (at t1 x1 y1) (at t8 x2 y1) (at t7 x3 y1) (at t2 x1 y2) 
            (at t6 x3 y2) (at t3 x1 y3) (at t4 x2 y3) (at t5 x3 y3))
    )
)